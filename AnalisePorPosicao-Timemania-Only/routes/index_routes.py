...
from services.api_timemania_service import ApiTimemaniaSService
...
def api_status_banco():
    try:
        return jsonify({"status": "success", **ApiTimemaniaSService.status_banco()})
...
def api_sincronizar():
    try:
        ...
        resultado = ApiTimemaniaSService.sincronizar_banco(
...
register_premiacao_caixa(index_bp, modality_key="timemania", sorteio_model=SorteioTimemania, db=db)
