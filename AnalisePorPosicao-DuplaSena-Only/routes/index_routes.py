...
from services.api_duplasena_service import ApiDuplaSenaService
...
def api_status_banco():
    try:
        return jsonify({"status": "success", **ApiDuplaSenaService.status_banco()})
...
def api_sincronizar():
    try:
        ...
        resultado = ApiDuplaSenaService.sincronizar_banco(
...
register_premiacao_caixa(index_bp, modality_key="duplasena", sorteio_model=SorteiosDuplaSena, db=db)
