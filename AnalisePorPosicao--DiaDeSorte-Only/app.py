...
def create_app():
    ...
    with app.app_context():
        ...
        import models.historico_analise_inteligente
        db.create_all()
        try:
        ...
        try:
            ...
            backfill_historico(limite=300, apenas_faltantes=True)
        except Exception:
            pass
...
if __name__ == '__main__':
    ...
    print(f"[URL] Gaps->Apostas: http://localhost:{porta}/geradores-elite/gaps-ciclo-apostas/")
