...
def _ciclos(sorteios: List[Dict[str, Any]], universo: int) -> List[Dict[str, Any]]:
...
class ResumoModalidadeService:
    ...
    def _analisar(cls, spec: ResumoSpec, sorteios: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        hip = "0-0-0-1-1-2-2"
        hip_q = padrao_inicial.get(hip, 0)
        ...
        checklist = [
            ...
            },
            {
                ...
                "neste": neste_pi,
                "uso": "Fique em 3–4 de cada lado no Dia de Sorte.",
                "tipo": "frequente",
            },
            {
                "criterio": "Faixas B / M / A",
                "ref": (
                ...
                "neste": neste_bma,
                "uso": "2 ou 3 em cada faixa. Não zere B, M ou A.",
                "tipo": "frequente",
            },
            {
            ...
            },
            {
                ...
                "neste": neste_pad,
                "uso": (
                    f"0-0-0-1-1-2-2 é o 3º ({_pct(hip_q, n)}%) — não é o mais frequente."
        ...
        if moda_ini and moda_ini["valor"] == hip:
            regras.append({
                "n": 7, "tipo": "frequente",
        ...
        return {
            "meta": {
                ...
                "universo": f"{n_s} dezenas de {spec.dezena_min}–{spec.dezena_max}"
