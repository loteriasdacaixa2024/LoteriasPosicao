...
def _inject_analises_novas_nav(cfg: dict, modality_key: str) -> None:
    ...
    try:
        ...
        tem_ciclo_cobertura = lambda _k: False  # noqa: E731
    try:
        from resumo_modalidade.specs import tem_resumo_modalidade
    except ImportError:
        tem_resumo_modalidade = lambda _k: False  # noqa: E731
    if tem_resumo_modalidade(modality_key):
    ...
    if tem_ciclo_cobertura(modality_key):
        novos_ge.append({
            ...
            "desc": "Estratégias · ritmo · fechamento · 2+1",
            "icon": "fas fa-sync-alt",
            "after": "/geradores-elite/repeticao-apostas/",
        })
    if tem_gaps_ciclo(modality_key):
        novos_ge.append({
            "href": "/geradores-elite/gaps-ciclo-apostas/",
