...
MODALIDADES = [
    ...
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only"),
    ...
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only"),
]
...
DETALHE = [
    ...
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Dados", "Sincronização & Sorteios", "/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Dados", "Análise por Coluna", "/analise/", "Freq/atraso C1–C7"),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Dados", "Repetição de Dígitos", "/analise/#repeticoes", "Âncora na mesma página"),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Análise", "Sniper por Colunas", "/analise/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Análise", "Central de Modelos (6 MODELOS)", "/modelos/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Análise", "Backtesting Histórico", "/modelos/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "—", "Conferência Histórica", "/central-conferencias/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "—", "Painel Geral", "/", ""),
    ("5160", "Super Sete", "AnalisePorPosicao-SuperSete-Only", "Geradores de Elite", "Engine Final", "/geradores-elite/engine-final/", ""),
    ...
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Dados", "Sincronização", "/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Dados", "Análise Estatística", "/analise/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Análise", "Sniper por Dezenas + Mês da Sorte", "/analise/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Análise", "Central de Modelos (6)", "/modelos/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Análise", "Backtesting Histórico", "/modelos/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "—", "Conferência", "/central-conferencias/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "—", "Desdobramento", "/desdobramento/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "—", "Painel", "/", ""),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "—", "Configurações", "/configuracoes/", "Só 5153"),
    ("5153", "Dia de Sorte", "AnalisePorPosicao--DiaDeSorte-Only", "Geradores de Elite", "Engine Final", "/geradores-elite/engine-final/", ""),
]

MATRIZ_ROWS = [
    ("Dados (submenu)", [1, 1, 1, 1, 1, 1, 1, 1, 1]),
    ("Atrasos posicionais", [1, 0, 0, 0, 0, 0, 0, 0, 0]),
    ("Análise por coluna / repetições", [0, 0, 0, 0, 0, 0, 0, 0, 1]),
    ("Análise (submenu: sniper + modelos)", [1, 1, 1, 1, 1, 1, 1, 1, 1]),
    ("Ranking de times", [0, 0, 0, 0, 0, 0, 0, 1, 0]),
    ("Desdobramento(s)", ["", "link", "", "", "Des1+Des2", "submenu", "link", "", ""]),
    ("Conferência (link simples)", [1, 1, 1, 1, 0, 1, 1, 1, 1]),
    ("Central de Conferências (3 itens)", [0, 0, 0, 0, 1, 0, 0, 0, 0]),
    ("Configurações", [0, 1, 0, 0, 0, 0, 0, 0, 0]),
...
def build_matriz(wb):
    ...
    ws["A2"] = "Portas 5152–5160 · 5151 = Dia de Sorte legado (fora deste mapa)"
    ws["A2"].font = subtitle_font
...
def build_legenda(wb):
    ...
    lines = [
        ...
        ("", "5151 não incluído — Dia de Sorte legado (AnalisePorPosicao-DiaDeSorte-Only). Oficial: 5153."),
    ]
    ws["A1"] = "Legenda"
    ws["A1"].font = title_font
